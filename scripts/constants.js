...
export const WARLORDS = [
    ...
    { name: "加藤嘉明", side: 'EAST', soldiers: 3000, atk: 82, def: 80, jin: 75, loyalty: 75, q: 36, r: 23, size: 1, p: P_BRAVE, kamon: 'DEFAULT', bg: '#444' },
    { name: "田中吉政", side: 'EAST', soldiers: 3000, atk: 80, def: 80, jin: 75, loyalty: 85, q: 32, r: 28, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#444' },
    { name: "藤堂高虎", side: 'EAST', soldiers: 2490, atk: 85, def: 85, jin: 85, loyalty: 88, q: 30, r: 30, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#555' },
    ...
    { name: "筒井定次", side: 'EAST', soldiers: 2850, atk: 75, def: 75, jin: 70, loyalty: 80, q: 34, r: 26, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#666' },
    { name: "生駒一正", side: 'EAST', soldiers: 1830, atk: 75, def: 70, jin: 65, loyalty: 80, q: 24, r: 36, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#666' },
    { name: "金森長近", side: 'EAST', soldiers: 1140, atk: 70, def: 70, jin: 60, loyalty: 85, q: 22, r: 38, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#666' },
    { name: "古田重勝", side: 'EAST', soldiers: 1200, atk: 70, def: 70, jin: 60, loyalty: 80, q: 20, r: 40, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#666' },
    ...
    { name: "榊原康政", side: 'EAST', soldiers: 1000, atk: 85, def: 85, jin: 80, loyalty: 100, q: 54, r: 33, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#222' },
    { name: "大久保忠隣", side: 'EAST', soldiers: 1000, atk: 80, def: 80, jin: 75, loyalty: 100, q: 56, r: 37, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#222' },
    { name: "酒井家次", side: 'EAST', soldiers: 1000, atk: 75, def: 75, jin: 70, loyalty: 100, q: 50, r: 38, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#222' },

    // --- 西軍 (石田) ---
    { name: "石田三成", side: 'WEST', soldiers: 6900, atk: 80, def: 85, jin: 95, loyalty: 100, q: 10, r: 15, size: 2, p: P_LOYAL, kamon: 'DAIICHI', bg: '#4a0080' },
    { name: "島左近", side: 'WEST', soldiers: 1000, atk: 95, def: 90, jin: 85, loyalty: 100, q: 12, r: 16, size: 1, p: P_BRAVE, kamon: 'DEFAULT', bg: '#8b0000' }, // 鬼左近の赤
    { name: "蒲生郷舎", side: 'WEST', soldiers: 800, atk: 80, def: 80, jin: 80, loyalty: 100, q: 11, r: 14, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#444' },
    ...
    { name: "小西行長", side: 'WEST', soldiers: 4000, atk: 80, def: 85, jin: 75, loyalty: 100, q: 18, r: 25, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#333' },
    ...
    { name: "大谷吉継", side: 'WEST', soldiers: 600, atk: 90, def: 90, jin: 95, loyalty: 100, q: 20, r: 35, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#fff' }, // 白頭巾
    { name: "大谷吉治", side: 'WEST', soldiers: 1000, atk: 75, def: 75, jin: 70, loyalty: 100, q: 19, r: 36, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#ccc' },
    { name: "戸田重政", side: 'WEST', soldiers: 1500, atk: 70, def: 70, jin: 60, loyalty: 100, q: 21, r: 34, size: 1, p: P_LOYAL, kamon: 'DEFAULT', bg: '#555' },
    { name: "平塚為広", side: 'WEST', soldiers: 360, atk: 75, def: 70, jin: 60, loyalty: 100, q: 20, r: 37, size: 1, p: P_BRAVE, kamon: 'DEFAULT', bg: '#555' },
    { name: "脇坂安治", side: 'WEST', soldiers: 990, atk: 70, def: 70, jin: 50, loyalty: 60, q: 15, r: 40, size: 1, p: P_COWARD, kamon: 'DEFAULT', bg: '#666' },
    { name: "朽木元綱", side: 'WEST', soldiers: 600, atk: 65, def: 65, jin: 50, loyalty: 60, q: 16, r: 41, size: 1, p: P_COWARD, kamon: 'DEFAULT', bg: '#666' },
    ...
    { name: "安国寺恵瓊", side: 'WEST', soldiers: 1800, atk: 70, def: 70, jin: 75, loyalty: 90, q: 52, r: 48, size: 1, p: P_CALM, kamon: 'DEFAULT', bg: '#555' },
    { name: "長宗我部盛親", side: 'WEST', soldiers: 6600, atk: 88, def: 85, jin: 80, loyalty: 80, q: 55, r: 45, size: 1, p: P_BRAVE, kamon: 'DEFAULT', bg: '#333' },
